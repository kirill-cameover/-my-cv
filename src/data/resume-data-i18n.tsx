...
export const RESUME_DATA_I18N: Record<Locale, ResumeData> = {
  ru: {
    ...
    summary: (
      <>
        <p>
        <b>Продажи → Партнёрства → Медиа. Формирую команды и продажи. Делаю YouTube проекты прибыльными.</b>
        </p>
        ...
        Организовал более 100 съёмок подкастов.
        </p>
    ...
    competencies: [
      ...
      },
      {
        ...
        items: [
          ...
          "Организация съёмок и производства медиа-контента",
